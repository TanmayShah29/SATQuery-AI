    ...
    map.on('click', (e) => {
      ...
      try {
        const features = map.queryRenderedFeatures(bbox, {
          layers: ['pins-inner-core', 'pins-outer-pulse'],
        });
    ...
    <div className="relative w-full h-full overflow-hidden bg-[#080A0F]">
      ...
      {!isLandingMode && (
        <div
          ...
          className="absolute right-3 top-1/2 -translate-y-1/2 z-30 flex flex-col select-none bg-[#0C1017]/85 border border-[#1E2638] backdrop-blur-md p-1 rounded-lg shadow-xl"
        >
